...
export namespace JSXInternal {
	...
	export interface SVGAttributes extends AriaAttributes, JSXAttributes {
		id?: string;
		lang?: string;
		tabIndex?: number | string;
		tabindex?: number | string;
	...
	export interface ContainerElementSVGAttributes
		extends SVGAttributes,
	...
	export interface GraphicsElementSVGAttributes
		extends SVGAttributes,
			Pick<
				PresentationSVGAttributes,
				| 'clip-rule'
	...
	export interface LightSourceElementSVGAttributes extends SVGAttributes {}
	...
	export interface ShapeElementSVGAttributes
		extends SVGAttributes,
			Pick<
				PresentationSVGAttributes,
				| 'color'
	...
	export interface SVGAnimateAttributes
		extends AnimationElementSVGAttributes,
	...
	export interface SVGCircleAttributes
		extends GraphicsElementSVGAttributes,
			ShapeElementSVGAttributes,
			ConditionalProcessingSVGAttributes,
			StylableSVGAttributes,
	...
	export interface SVGDefsAttributes
		extends ContainerElementSVGAttributes,
			ConditionalProcessingSVGAttributes,
			ExternalResourceSVGAttributes,
			StylableSVGAttributes,
			TransformableSVGAttributes {}

	export interface SVGDescAttributes extends SVGAttributes, StylableSVGAttributes {}
	...
	export interface SVGFeBlendAttributes
		extends FilterPrimitiveElementSVGAttributes,
	...
	export interface SVGFeFuncAttributes extends SVGAttributes {
	...
	export interface SVGFeMergeNodeAttributes extends SVGAttributes, SingleInputFilterSVGAttributes {}
	...
	export interface SVGForeignObjectAttributes
		extends NewViewportSVGAttributes,
			ConditionalProcessingSVGAttributes,
			ExternalResourceSVGAttributes,
			StylableSVGAttributes,
			TransformableSVGAttributes,
	...
	export interface SVGMaskAttributes
		extends Omit<ContainerElementSVGAttributes, 'opacity' | 'filter'>,
			ConditionalProcessingSVGAttributes,
			ExternalResourceSVGAttributes,
			StylableSVGAttributes {
		maskUnits?: SVGUnits;
	...
	export interface SVGTextAttributes
		extends TextContentElementSVGAttributes,
			GraphicsElementSVGAttributes,
			ConditionalProcessingSVGAttributes,
			ExternalResourceSVGAttributes,
			StylableSVGAttributes,
